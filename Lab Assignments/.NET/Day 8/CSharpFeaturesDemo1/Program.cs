...
namespace CSharpFeaturesDemo1
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //else
            //{
            //    Console.WriteLine($"No : {no} is less than 10");
            //} 
            #endregion
            ...
            // Anonymous Methods: Methods without name, local methods, can not be used else where in application, used for short purposes, like conditional check OR holder
            ...
            //// Extending in-built Data Types functionalities by writing specific classes using below Rules:
            //// To create Extension menthod:
            //// 1. Declare a static class
            //// 2. Declare a static method
            //// 3. Write 'this' keyword in front of that parameter which datatype functionality you want to extend!
            //// 4. Please NOte: this should always be a first parameter to the method.
            //// 5. We can pass other parameters after this parameter.
    ...
    public class MyCustomCollection : IEnumerable
    {
        ...
        public IEnumerator GetEnumerator()
        {
            ...
            {
                yield return arr[i];
                // yield keyword forces CLR to remember last element index, which we have returned from this for loop and next time returns next element by increasing index as per the for loop syntax condition.
            }
        }
    }
