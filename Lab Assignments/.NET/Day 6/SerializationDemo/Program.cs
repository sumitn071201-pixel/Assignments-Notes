...
namespace SerializationDemo
{
    internal class Program
    {
        ...
        {
            string filePath = @"C:\Users\IET\Desktop\.NET\CSharpDemos\SerializationDemo\Files\data.xml";

            string filePath1 = @"C:\Users\IET\Desktop\.NET\CSharpDemos\SerializationDemo\Files\data.json";
