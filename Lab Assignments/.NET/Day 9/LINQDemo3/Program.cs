...
namespace LINQDemo3
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //This is just writing/declaring LINQ Query
            //var result = from emp in emps
            //             where emp.Address.ToLower().StartsWith(city)
            //             select emp;
            // This behavior of LINQ , where LINQ query gets fired when you start using it is known as : LAZY LOADING OF LINQ or Delayed Execution of LINQ Query
