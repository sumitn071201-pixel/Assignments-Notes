...
namespace CSharpFeaturesDemo
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // int? deptID = null; // a value type can hold null value if we use nullable operator ( ? )
            //int? deptID = 232323;
            //if (deptID.HasValue)
            //{
            ...
            // Implicit type is getting defination at compile time only
            ...
            //var v1; // defination: unknown-> compiler error
            //object obj;
            //int j;
            ...
            // var is always local scope
            // var can not be used as a parameter type of a method
    ...
    public class Emp
    {
        ...
        //    set { _Id = value; }
        //}
        // If there is a scenario where names of the private members does not matter: then we go for auto-property syntax: where compiler generates : Private Members along with getter and setter methods for us. And we use or communicate with the help of public properties.
        // Please note: we can not do any kind of validations or changes using property syntax or by using private member names
    ...
    public class Demo
    {
        ...
        #region Manually constructor writing code based on combinations of private fields initialization.
        //public Demo()
        //{
